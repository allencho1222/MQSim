...
public:
  Input_Stream_SATA(LHA_type start_logical_sector_address,
      ...
      : Input_Stream_Base(),
        ...
        Submission_head(0), Submission_head_informed_to_host(0),
        Submission_tail(0), Completion_head(0), Completion_tail(0),
...
public:
  Input_Stream_Manager_SATA(Host_Interface_Base *host_interface,
                            ...
                            LHA_type start_logical_sector_address,
                            LHA_type end_logical_sector_address);
  void Set_ncq_address(uint64_t submission_queue_base_address,
                       uint64_t completion_queue_base_address);
...
public:
  Request_Fetch_Unit_SATA(Host_Interface_Base *host_interface,
                          uint16_t ncq_depth);
...
public:
  Host_Interface_SATA(const sim_object_id_type &id, const uint16_t ncq_depth,
