...
NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(
    ...
    NVM::memory_content_type content, NVM_Transaction_Flash_WR *related_write,
    page_status_type read_sectors_bitmap, data_timestamp_type data_timestamp)
    : NVM_Transaction_Flash(
          source, Transaction_Type::READ, stream_id, data_size_in_byte, lpa,
          ppa, related_user_IO_request, IO_Flow_Priority_Class::UNDEFINED),
      Content(content), RelatedWrite(related_write),
      read_sectors_bitmap(read_sectors_bitmap), DataTimeStamp(data_timestamp) {}
...
NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(
    ...
    NVM::memory_content_type content, NVM_Transaction_Flash_WR *related_write,
    page_status_type read_sectors_bitmap, data_timestamp_type data_timestamp)
    : NVM_Transaction_Flash(source, Transaction_Type::READ, stream_id,
                            data_size_in_byte, lpa, ppa, address,
...
NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(
    ...
    : NVM_Transaction_Flash(source, Transaction_Type::READ, stream_id,
                            data_size_in_byte, lpa, ppa,
                            related_user_IO_request, priority_class),
      Content(content), RelatedWrite(NULL),
      read_sectors_bitmap(read_sectors_bitmap), DataTimeStamp(data_timestamp) {}
