...
public:
  ...
  sim_object_id_type ID() { return this->_id; }

  bool IsTriggersSetUp() { return _triggersSetUp; }

  // The Start function is invoked at the start phase of simulation to perform
  // initialization
  virtual void Start_simulation(bool isPreconditioning) = 0;
  ...
  // from other objects
  virtual void Setup_triggers() { _triggersSetUp = true; }
