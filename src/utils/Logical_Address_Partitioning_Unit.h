...
public:
  static void Reset();
  static void Allocate_logical_address_for_flows(
  ...
  static LHA_type
  LHA_count_allocate_to_flow_from_host_view(stream_id_type stream_id);
  static LHA_type
  LHA_count_allocate_to_flow_from_device_view(stream_id_type stream_id);
  static PDA_type PDA_count_allocate_to_flow(stream_id_type stream_id);
  static double Get_share_of_physcial_pages_in_plane(
